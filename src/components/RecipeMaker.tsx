...
export default function RecipeMaker({ makeRecipe }: Props) {
    ...
    return <div className="">
        <form onSubmit={submit} className="flex flex-col justify-center">
            ...
            <button type="submit" className="rounded-full m-2 bg-white/10 px-10 py-3 font-semibold text-white no-underline transition hover:bg-white/20" onClick={() => { makeRecipe(input) }}>Make recipe!</button>
        </form>
    </div>
}